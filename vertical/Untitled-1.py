...
# %% [markdown]
# # Altitude Boundaries and State Limits
...
for phase in phases:
    ...
    for k in range(N_phase):
        ...
        opti.subject_to(U[0, k] <= 100000)   # Thrust upper bound
...
# -------------------------
p_opts = {"expand": True}
s_opts = {"max_iter": 500, "print_level": 5, "tol":1e-6, "acceptable_tol":1e-4}
...
# %% [markdown]
# **TODO:** Relax the altitude and climb speed constraints.
