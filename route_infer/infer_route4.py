...
def find_route(graph, segments_df, error_threshold=7.5, distance_threshold_for_segment_skipping=20, max_wp_search_radius=7, min_wp_search_radius=2):
    ...
    """
    final_route, new_nodes = process_flight_segments(graph, segments_df, error_threshold=error_threshold, max_radius=max_wp_search_radius, min_radius=min_wp_search_radius)
