...
def mcmc_step(route_graph, route, temperature = 1000, max_depth = 4,
    ...
    # c_max = min(a+3, eligible_range[1] + 1)
    ...
    if verbose:
        ...
        # Print some collapsed pivot nodes:
        # for node in list(V_distances_collapsed.keys())[:5]:
        #     print(f'  {node}: dist={V_distances_collapsed[node]["forward_dist"][1] + V_distances_collapsed[node]["backward_dist"][1]:.2f}')
